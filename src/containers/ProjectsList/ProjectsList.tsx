...
export const ProjectsList = ({ projects }: I.ProjectsListProps) => {
  return (
    // TODO: Colocar carousel na versão tablet e mobile
    <ul className="grid gap-8 rounded-lg border-1 border-gray-700 p-4 lg:grid-cols-[repeat(auto-fit,minmax(280px,1fr))]">
